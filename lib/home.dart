...
import 'package:new_pages/ui_for_home.dart';
import "package:permission_handler/permission_handler.dart";

//these packages are included for icons

import 'package:new_pages/app_icons.dart';
import 'package:new_pages/images_icons.dart';
import 'package:new_pages/contact_icons.dart';
...
/*
  ...
  static  permissionHandling() async {
                          ...
                          children:[
                            ...
                            Row(
                              children: [
                                UiForHome.cardDesign(context,icon:ContactCalender.perm_contact_calendar,text:"contacts",onTap:"contacts",color:const Color(0xffb56a00),  ),//contact
                                SizedBox(width:UiForHome.rowGapSizedBoxWidth(context)),//gap
                                UiForHome.cardDesign(context,icon:Icons.sticky_note_2_sharp,text:"notes",onTap:"notes",color:const Color(0xff918b50),  ),//notes
                              ],
                            ),
                            SizedBox(height:UiForHome.columnGapSizedBoxHeight),
                            Row(
